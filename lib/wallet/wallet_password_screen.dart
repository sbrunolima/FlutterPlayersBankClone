...
class WalletPasswordScreen extends StatefulWidget {
  static const routeName = '/wallet-password-screen';

  @override
  State<WalletPasswordScreen> createState() => _PasswordScreenState();
}

class _PasswordScreenState extends State<WalletPasswordScreen> {
  final _text =
